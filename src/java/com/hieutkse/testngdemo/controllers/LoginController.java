...
import com.hieutkse.testngdemo.daos.RegistrationDAO;
import com.hieutkse.testngdemo.dtos.RegistrationDTO;
import com.hieutkse.testngdemo.dtos.RegistrationErrorObject;
...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (username.equals("")) {
                valid = false;
                errorObject.setUsernameError("User can't be blank");
            }
            if (password.equals("")) {
                valid = false;
